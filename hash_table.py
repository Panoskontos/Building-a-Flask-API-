# it is not a very performant hash table but it works for the project 
...
class HashTable:
	...
	def custom_hash(self, key):
		hash_value = 0
		for i in key:
			# helps to iterate through Every character
			hash_value += ord(i)
			# % helps so it can never be greater from our table
	...
	def add_key_value(self, key, value):
		...
		if self.hash_table[hashed_key] is None:
			...
			# create a linked list and assign it to the last node
